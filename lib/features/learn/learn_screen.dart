      ...
      body: itemsAsync.when(
        ...
        data: (items) {
          ...
          return ListView(
            padding: const EdgeInsets.all(12),
            children: [
              section(t.basicPrinciplesCount(principles.length), principles),
              section(t.importantHerbsCount(herbs.length), herbs),
              section(t.diseasesConditionsCount(diseases.length), diseases),
            ],
          );
        },
      ),
