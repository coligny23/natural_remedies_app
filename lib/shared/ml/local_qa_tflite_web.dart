...
/// Web build cannot use tflite_flutter; this class name exists so imports compile.
/// It simply delegates to the stub.
class LocalQaTflite implements LocalQaEngine {
  final LocalQaStub _stub = LocalQaStub();
  @override
  Future<void> init({required List<ContentItem> corpus, required String lang}) =>
      _stub.init(corpus: corpus, lang: lang);

  @override
  Future<QaAnswer> answer(String query) => _stub.answer(query);
}
